...
const UPDATE_BOOK = gql`
  mutation UpdateBook($id: ID!, $title: String!, $author: String!, $status: String!, $rating: Int, $notes: String) {
    updateBook(id: $id, title: $title, author: $author, status: $status, rating: $rating, notes: $notes) {
      id
      title
      author
      status
